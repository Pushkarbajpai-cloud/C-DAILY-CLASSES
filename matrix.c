...
int main() {
    ...
    scanf("%d %d %d %d", &arr[0][0], &arr[0][1], &arr[1][0], &arr[1][1]);// used this to get the values from the user and store them to my array
    printf("matrix:\n");
    for(int i=0;i<2;i++){ // i used this to allocate the values into the order of matrix
        for(int j=0;j<2;j++){
            printf("%d ", arr[i][j]);
        }
        printf("\n");
